...
resource "aws_instance" "ec2" {
  ...
  #user_data_base64        =  "${ each.value["instance-info"]["ami_id"] == "ami-074cce78125f09d61" ? base64encode(file("../../../../modules/ec2/install_jenkins_userdata.sh")) : (each.value["instance-info"]["ami_id"] == "ami-0ba62214afa52bec7" ? base64encode(file("../../../../modules/ec2/install_ansible_userdata.sh")) : null)}"
